...
{ 1, N_("Export Sketch..."),            Command::EXPORT_VIEW,      0,       KN, mFile  },
{ 1, N_("Export 2d &Section of Model..."),       Command::EXPORT_SECTION,   0,       KN, mFile  },
...
{ 1,  NULL,                             Command::NONE,             0,       KN, NULL   },
{ 1, N_("Chain Select"),                Command::SELECT_CHAIN,     ' ',     KN, mEdit  },
...
{ 1, N_("Zoom To &Fit"),                Command::ZOOM_TO_FIT,      C|'f',   KN, mView  },
{ 1,  NULL,                             Command::NONE,             0,       KN, NULL   },
...
{ 1, N_("Show Property Bro&wser"),      Command::SHOW_TEXT_WND,    0,       KC, mView  },
{ 1,  NULL,                             Command::NONE,             0,       KN, NULL   },
{ 1, N_("&Full Screen"),                Command::FULL_SCREEN,      C|F|11,  KC, mView  },

{ 0, N_("Sketch"),                      Command::NONE,             0,        KN, mReq  },
{ 1, N_("New 3D Sketch"),               Command::GROUP_3D,         S|'3',   KN, mGrp   },
{ 1, N_("New Workplane Sketch"),        Command::GROUP_WRKPL,      S|'w',   KN, mGrp   },
{ 1, N_("In &Workplane"),               Command::SEL_WORKPLANE,    '2',     KR, mReq   },
{ 1, N_("Anywhere In &3d"),             Command::FREE_IN_3D,       '3',     KR, mReq   },
{ 1, NULL,                              Command::NONE,             0,       KN, NULL   },
{ 1, N_("Datum &Point"),                Command::DATUM_POINT,      0,       KN, mReq   },
{ 1, N_("&Workplane"),                  Command::WORKPLANE,        0,       KN, mReq   },
{ 1, NULL,                              Command::NONE,             0,       KN, NULL   },
{ 1, N_("&Line Segment"),               Command::LINE_SEGMENT,     'l',     KN, mReq   },
...
{ 1, N_("&Arc"),                        Command::ARC,              'a',     KN, mReq   },
{ 1, N_("&Cubic Spline"),               Command::CUBIC,            'b',     KN, mReq   },
{ 1, NULL,                              Command::NONE,             0,       KN, NULL   },
...
{ 1, N_("Toggle R&eference Dim"),       Command::REFERENCE,        0,       KN, mCon   },
{ 1, NULL,                              Command::NONE,             0,       KN, NULL   },
...
{ 1, N_("&Website"),           Command::WEBSITE,          0,                KN, mHelp  },
#ifndef __APPLE__
